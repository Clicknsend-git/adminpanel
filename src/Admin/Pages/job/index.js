    ...
    await apiAdminConfig
      ...
      .then((response) => {
        if (response.status === 200) {
          ...
          setPageSize(response?.data?.view_data?.meta?.per_page);
          setPageData(response?.data?.view_data?.meta);
              ...
              >
                ...
                <Box>
                  <Button
                    ...
                    onClick={() => {
                      navigate(`/master/job/jobs/${value}/create`);
                    }}
                  >
                    Add Job
                  </Button>
              ...
              <div>
                ...
                {open && (
                  <Popup
                    ...
                    setOpen={setOpen}
                    actionURL="/api/auth/master/jobs/delete"
                  />
                )}
              </div>{" "}
            </CardContent>
